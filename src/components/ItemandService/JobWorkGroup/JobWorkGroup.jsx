...
const resetOther = () => {
  ...
  return (
    <div className="new_inventory_group_main1">
        <Page_heading main={"Group of Items Received for JobWork"} parent={"Item & Service"} child={"Item Received for JobWork "} />
