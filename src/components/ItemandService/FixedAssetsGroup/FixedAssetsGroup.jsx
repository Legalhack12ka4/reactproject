...
const resetOther = () => {
  ...
  return (
    <div className="new_inventory_group_main_fix" style={{overflow:"hidden"}}>
        <Page_heading parent={"Item & Service"} child={"Fixed Assets"}  />

        <div className="new_inventory_group_container_fix">
...
export default FixedAssetsGroup
