...
//   const [search, setSearch] = useState("");
  ...
  const filteredData = dataSource.filter((record) =>
    record.invoice_order.toLowerCase().includes(search.toLowerCase())
  );
  //Filter field
  ...
  const cusomizeData = dataSource.filter(
    (record) =>
      record.invoice_order.includes(custfilter.lead) 
    //   &&
    //   record.ownership.includes(custfilter.ownership)
      && record.invoice_order.toLowerCase().includes(search.toLowerCase())
...
// }
  return (
    ...
    <div className="invoice-data">
      <Page_heading parent={"Sales"} child={"Invoice"} />
