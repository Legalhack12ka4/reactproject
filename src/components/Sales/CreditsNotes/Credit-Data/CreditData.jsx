...
//   const [search, setSearch] = useState("");
  ...
  const filteredData = dataSource.filter((record) =>
    record.credit_notes.toLowerCase().includes(search.toLowerCase())
  );
  //Filter field
  ...
  const cusomizeData = dataSource.filter(
    (record) =>
      record.credit_notes.includes(custfilter.lead) 
    //   &&
    //   record.ownership.includes(custfilter.ownership)
      && record.credit_notes.toLowerCase().includes(search.toLowerCase())
...
// }
  return (
    ...
    <div className="credit-data">
      <Page_heading parent={"Sales"} child={"Credit Notes"} />
      ...
      <div className="filter-searchbar-container">
        <FilterAndSearchBar
          ...
          addBtnName={"Credit Notes"}
          onData={handleData}
          path={"add_credit_notes"}
        //   filter={<Leads />}
          onFilter={(e) => {
            clearfilter(e);
            setVisible(!visible);
