...
//   const [search, setSearch] = useState("");
  ...
  const filteredData = dataSource.filter((record) =>
    record.bills.toLowerCase().includes(search.toLowerCase())
  );
  //Filter field
  ...
  const cusomizeData = dataSource.filter(
    (record) =>
      record.bills.includes(custfilter.lead) 
    //   &&
    //   record.ownership.includes(custfilter.ownership)
      && record.bills.toLowerCase().includes(search.toLowerCase())
...
// }
  return (
    ...
    <div className="bills-data">
      <Page_heading parent={"Purchase"} child={"Bills"} />
