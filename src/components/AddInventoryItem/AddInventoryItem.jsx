  ...
  return (
    <div className="add-inventory">
      ...
      <div className="main_container">
        ...
        <div className= {`${image.length ===0 ? "img_uploader_main":"img_uploader_main_pre"}`}>
          <div className="upload_image_container" onClick={image.length === 0 ? handleClick:""}>
            <p className="item_image_heading"> Item Image</p>
            <div className={`${image.length ===0 ? "img_uploader":"imguploader_pre"}`}>
              <div className="image_prev">
                {image.length >0 && <button onClick={handleDelete} className="close_image"><img src="/images/icons/image_close_icon.svg" alt="" /></button>}
              ...
              {dots.map((dot, index) => {
                return (
                  <span
                    key={index}
                    className={index === currentIndex ? "dotActive" : "dotNotActive"}
                    onClick={() => {
              ...
              <h3 onClick={handleClick}>{image.length === 0 ? "Drop files here or click to upload": "+ Add Images"}</h3>
              ...
              {image.length === 0 && (
                <p className="image_desc">
                  <span>You Can add up to <span className="image_text_bold">5 Images</span></span>
                  <span>each not exceeding <span className="image_text_bold">2 MB.</span></span>
                </p>
              )}
            </div>
          </div>
